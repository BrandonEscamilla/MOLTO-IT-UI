...
const Results = ({ moltoItApiClient, newProps }) => {
  ...
  useEffect(() => {
    ...
    socket.on("connect", () => {
      ...
      socket.emit("on_connect_data", {
        problem_name: moltoItData.problem_name,
        generations: moltoItData.maxGen,
      });
                    ...
                    <React.Fragment key={index}>
                      ...
                      >
                        <td
                          style={{
                            backgroundColor:
                              moltoItData.plot - 1 === index ? "#70C483" : null,
                            opacity:
                              moltoItData.plot - 1 === index ? 0.9 : null,
                          }}
                        >
                          {value["y"]}
                        </td>
